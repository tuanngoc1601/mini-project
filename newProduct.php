...
<head>
    ...
    <link rel="stylesheet" href="./assets/stylesheets/newProductStyle.css" />
                ...
                <form action="newProduct.php" method="post" class="new-product-form">
                    <div class="form-content">
                        <div class="form-group w-75">
                            ...
                            <input class="form-control" type="text" name="name" id="name" required minlength="1" />
                        </div>
                        <div class="form-group w-25">
                            <label for="price">Product price: </label><br />
                            <input class="form-control" type="number" name="price" id="price" required min="0" pattern="[0-9]*[.,]?[0-9]+" />
                        </div>
